<?php
/**
 * Admin viewer for form submissions
 * Password-protected page to view all contact form submissions
 */
          ...
          <tbody>
            <?php foreach ($submissions as $sub): ?>
              <tr>
                ...
                <td>
                  <span class="status-badge <?= $sub['confirm_email_sent'] ? 'status-success' : 'status-failure' ?>">
                    <?= $sub['confirm_email_sent'] ? '✓ Sent' : '✗ Failed' ?>
                  </span>
                </td>
                <td>
                  <span class="status-badge <?= $sub['meta_api_sent'] ? 'status-success' : 'status-failure' ?>">
