...
<head>
    ...
    <title>Delete Kelburn Submission</title>
...
<body>
    <div class="container">
        <h1>Delete Kelburn Submission</h1>
        ...
        if ($submission) {
            ...
            echo "<a href='delete-kelburn.php' class='btn' style='background: #6c757d; color: white; text-decoration: none; display: inline-block; padding: 0.5rem 1rem; border-radius: 4px;'>Cancel</a>";
            echo "</form>";
        } else {
            ...
            <p style="margin-top: 2rem;"><a href="view-kelburn.php">← Back to View Submissions</a></p>
            <?php
        }
        ?>
    </div>
