...
if (!file_exists('../config/mail-config-newlands.php')) {
  http_response_code(500);
  echo "Mail configuration not found. Please create mail-config-newlands.php in config/ folder";
  exit;
}
require_once('../config/mail-config-newlands.php');
...
try {
  ...
  if ($adminEmailSent && $confirmEmailSent) {
    ...
    // Redirect back to the page they came from, or fallback to index.html
